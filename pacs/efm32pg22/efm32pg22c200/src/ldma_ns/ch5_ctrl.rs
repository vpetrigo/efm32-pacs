...
pub type STRUCTTYPE_W<'a> = crate::FieldWriter<'a, u32, CH5_CTRL_SPEC, u8, STRUCTTYPE_A, 2, 0>;
...
pub type DONEIEN_W<'a> = crate::BitWriter<'a, u32, CH5_CTRL_SPEC, bool, 20>;
...
pub type REQMODE_W<'a> = crate::BitWriter<'a, u32, CH5_CTRL_SPEC, REQMODE_A, 21>;
impl<'a> REQMODE_W<'a> {
