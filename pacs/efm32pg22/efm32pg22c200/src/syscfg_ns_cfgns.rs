...
pub struct RegisterBlock {
    ...
    pub cfgnstcalib: crate::Reg<cfgnstcalib::CFGNSTCALIB_SPEC>,
    _reserved1: [u8; 0x05e0],
    #[doc = "0x600 - Generic data space for user to pass to root, e.g., address of struct in mem"]
    pub rootnsdata0: crate::Reg<rootnsdata0::ROOTNSDATA0_SPEC>,
    #[doc = "0x604 - Generic data space for user to pass to root, e.g., address of struct in mem"]
    pub rootnsdata1: crate::Reg<rootnsdata1::ROOTNSDATA1_SPEC>,
}
#[doc = "CFGNSTCALIB register accessor: an alias for `Reg<CFGNSTCALIB_SPEC>`"]
pub type CFGNSTCALIB = crate::Reg<cfgnstcalib::CFGNSTCALIB_SPEC>;
#[doc = "Configure to define the system tick for the M33."]
pub mod cfgnstcalib;
#[doc = "ROOTNSDATA0 register accessor: an alias for `Reg<ROOTNSDATA0_SPEC>`"]
...
pub mod rootnsdata0;
#[doc = "ROOTNSDATA1 register accessor: an alias for `Reg<ROOTNSDATA1_SPEC>`"]
