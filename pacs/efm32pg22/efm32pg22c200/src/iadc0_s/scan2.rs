...
pub type PINNEG_W<'a> = crate::FieldWriter<'a, u32, SCAN2_SPEC, u8, u8, 4, 0>;
...
pub type PORTNEG_W<'a> = crate::FieldWriter<'a, u32, SCAN2_SPEC, u8, PORTNEG_A, 4, 4>;
impl<'a> PORTNEG_W<'a> {
...
pub type PINPOS_W<'a> = crate::FieldWriter<'a, u32, SCAN2_SPEC, u8, u8, 4, 8>;
...
pub type PORTPOS_W<'a> = crate::FieldWriter<'a, u32, SCAN2_SPEC, u8, PORTPOS_A, 4, 12>;
impl<'a> PORTPOS_W<'a> {
    #[doc = "Ground"]
    #[inline(always)]
    pub fn gnd(self) -> &'a mut W {
...
pub type CFG_W<'a> = crate::BitWriter<'a, u32, SCAN2_SPEC, CFG_A, 16>;
impl<'a> CFG_W<'a> {
...
pub type CMP_W<'a> = crate::BitWriter<'a, u32, SCAN2_SPEC, bool, 17>;
impl R {
