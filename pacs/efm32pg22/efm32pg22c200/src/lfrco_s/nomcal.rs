...
pub type NOMCALCNT_W<'a> = crate::FieldWriter<'a, u32, NOMCAL_SPEC, u32, u32, 21, 0>;
impl R {
    #[doc = "Bits 0:20 - Nominal Calibration Count"]
    #[inline(always)]
    pub fn nomcalcnt(&self) -> NOMCALCNT_R {
        NOMCALCNT_R::new((self.bits & 0x001f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:20 - Nominal Calibration Count"]
    #[inline(always)]
    pub fn nomcalcnt(&mut self) -> NOMCALCNT_W {
