...
pub type AVDDBODEN_W<'a> = crate::BitWriter<'a, u32, BOD3SENSE_SPEC, bool, 0>;
...
pub type VDDIO0BODEN_W<'a> = crate::BitWriter<'a, u32, BOD3SENSE_SPEC, bool, 1>;
...
pub type VDDIO1BODEN_W<'a> = crate::BitWriter<'a, u32, BOD3SENSE_SPEC, bool, 2>;
impl R {
...
impl W {
    #[doc = "Bit 0 - AVDD BOD enable"]
    #[inline(always)]
    pub fn avddboden(&mut self) -> AVDDBODEN_W {
        AVDDBODEN_W::new(self)
    }
    #[doc = "Bit 1 - VDDIO0 BOD enable"]
    #[inline(always)]
    pub fn vddio0boden(&mut self) -> VDDIO0BODEN_W {
        VDDIO0BODEN_W::new(self)
    }
    #[doc = "Bit 2 - VDDIO1 BOD enable"]
    #[inline(always)]
    pub fn vddio1boden(&mut self) -> VDDIO1BODEN_W {
