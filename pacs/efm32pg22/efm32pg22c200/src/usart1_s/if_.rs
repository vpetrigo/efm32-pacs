...
pub type TXBL_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 1>;
...
pub type RXDATAV_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 2>;
...
pub type TXUF_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 7>;
...
pub type SSM_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 11>;
...
pub type TCMP0_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 14>;
...
pub type TCMP1_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 15>;
...
pub type TCMP2_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 16>;
impl R {
