...
pub type PRSSEL_W<'a> = crate::FieldWriter<'a, u32, CONSUMER_IADC0_SCANTRIGGER_SPEC, u8, u8, 4, 0>;
...
pub type SPRSSEL_W<'a> = crate::FieldWriter<'a, u32, CONSUMER_IADC0_SCANTRIGGER_SPEC, u8, u8, 2, 8>;
impl R {
