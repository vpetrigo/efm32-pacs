...
pub type PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CC1_CTRL_SPEC, u8, PRSSEL_A, 2, 16>;
impl<'a> PRSSEL_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 16:17 - Compare/Capture Channel PRS Input Channel Selection"]
    #[inline(always)]
    pub fn prssel(&self) -> PRSSEL_R {
        PRSSEL_R::new(((self.bits >> 16) & 3) as u8)
    }
