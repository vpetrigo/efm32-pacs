...
pub type S0PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S0PRSSEL_A, 2, 0>;
impl<'a> S0PRSSEL_W<'a> {
...
pub type S1PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S1PRSSEL_A, 2, 6>;
impl<'a> S1PRSSEL_W<'a> {
    #[doc = "PRS Channel 0 selected."]
    #[inline(always)]
    pub fn prsch0(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:1 - S0IN PRS Channel Select"]
    #[inline(always)]
    pub fn s0prssel(&self) -> S0PRSSEL_R {
        S0PRSSEL_R::new((self.bits & 3) as u8)
    }
    ...
    #[doc = "Bits 6:7 - S1IN PRS Channel Select"]
    #[inline(always)]
    pub fn s1prssel(&self) -> S1PRSSEL_R {
        S1PRSSEL_R::new(((self.bits >> 6) & 3) as u8)
    }
