...
#[repr(u8)]
pub enum HFXOMODE_A {
    #[doc = "0: 4-24 MHz crystal oscillator."]
    XTAL = 0,
    #[doc = "1: An AC coupled buffer is coupled in series with HFXTAL_N, suitable for external sine wave (4-24 MHz). The sine wave should have a minimum of 200 mV peak to peak."]
    BUFEXTCLK = 1,
...
impl<'a> HFXOMODE_W<'a> {
    #[doc = "4-24 MHz crystal oscillator."]
    #[inline(always)]
    pub fn xtal(self) -> &'a mut W {
        self.variant(HFXOMODE_A::XTAL)
    }
    #[doc = "An AC coupled buffer is coupled in series with HFXTAL_N, suitable for external sine wave (4-24 MHz). The sine wave should have a minimum of 200 mV peak to peak."]
    #[inline(always)]
