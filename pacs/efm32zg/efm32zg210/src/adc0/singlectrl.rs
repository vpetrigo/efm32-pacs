...
pub type PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, SINGLECTRL_SPEC, u8, PRSSEL_A, 2, 28>;
impl<'a> PRSSEL_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 28:29 - Single Sample PRS Trigger Select"]
    #[inline(always)]
    pub fn prssel(&self) -> PRSSEL_R {
        PRSSEL_R::new(((self.bits >> 28) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Single Sample Repetitive Mode"]
