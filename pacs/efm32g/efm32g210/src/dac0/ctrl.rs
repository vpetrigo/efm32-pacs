...
pub enum OUTMODE_A {
    ...
    DISABLE = 0,
    #[doc = "1: DAC output to pin enabled. DAC output to ADC disabled"]
    PIN = 1,
    #[doc = "2: DAC output to pin disabled. DAC output to ADC enabled"]
    ADC = 2,
    #[doc = "3: DAC output to pin and ADC enabled"]
    PINADC = 3,
}
...
impl<'a> OUTMODE_W<'a> {
    ...
    #[doc = "DAC output to pin enabled. DAC output to ADC disabled"]
    #[inline(always)]
    pub fn pin(self) -> &'a mut W {
        self.variant(OUTMODE_A::PIN)
    }
    #[doc = "DAC output to pin disabled. DAC output to ADC enabled"]
    #[inline(always)]
    pub fn adc(self) -> &'a mut W {
        self.variant(OUTMODE_A::ADC)
    }
    #[doc = "DAC output to pin and ADC enabled"]
    #[inline(always)]
