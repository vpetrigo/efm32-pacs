...
pub type CSPOL_W<'a> = crate::BitWriter<'a, u32, POLARITY_SPEC, bool, 0>;
...
pub type REPOL_W<'a> = crate::BitWriter<'a, u32, POLARITY_SPEC, bool, 1>;
...
pub type WEPOL_W<'a> = crate::BitWriter<'a, u32, POLARITY_SPEC, bool, 2>;
...
pub type ALEPOL_W<'a> = crate::BitWriter<'a, u32, POLARITY_SPEC, bool, 3>;
#[doc = "Field `ARDYPOL` reader - ARDY Polarity"]
pub type ARDYPOL_R = crate::BitReader<bool>;
#[doc = "Field `ARDYPOL` writer - ARDY Polarity"]
pub type ARDYPOL_W<'a> = crate::BitWriter<'a, u32, POLARITY_SPEC, bool, 4>;
impl R {
