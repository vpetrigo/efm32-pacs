...
impl BIAS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<BIAS_A> {
        match self.bits {
            0 => Some(BIAS_A::STATIC),
            1 => Some(BIAS_A::ONEHALF),
            2 => Some(BIAS_A::ONETHIRD),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `STATIC`"]
...
pub type BIAS_W<'a> = crate::FieldWriter<'a, u32, DISPCTRL_SPEC, u8, BIAS_A, 2, 2>;
impl<'a> BIAS_W<'a> {
    #[doc = "Static"]
    #[inline(always)]
    pub fn static_(self) -> &'a mut W {
