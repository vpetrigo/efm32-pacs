...
pub type LCD_W<'a> = crate::FieldWriterSafe<'a, u32, LFAPRESC0_SPEC, u8, LCD_A, 2, 8>;
impl<'a> LCD_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 8:9 - Liquid Crystal Display Controller Prescaler"]
    #[inline(always)]
    pub fn lcd(&self) -> LCD_R {
        LCD_R::new(((self.bits >> 8) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Real-Time Counter Prescaler"]
