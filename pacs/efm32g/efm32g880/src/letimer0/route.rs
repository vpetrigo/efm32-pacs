...
pub type OUT0PEN_W<'a> = crate::BitWriter<'a, u32, ROUTE_SPEC, bool, 0>;
...
pub type OUT1PEN_W<'a> = crate::BitWriter<'a, u32, ROUTE_SPEC, bool, 1>;
#[doc = "I/O Location\n\nValue on reset: 0"]
...
pub type LOCATION_W<'a> = crate::FieldWriterSafe<'a, u32, ROUTE_SPEC, u8, LOCATION_A, 2, 8>;
impl<'a> LOCATION_W<'a> {
    #[doc = "Location 0"]
    #[inline(always)]
