...
pub type PRSUPSEL_W<'a> = crate::FieldWriter<'a, u32, CALCTRL_SPEC, u8, PRSUPSEL_A, 4, 16>;
impl<'a> PRSUPSEL_W<'a> {
...
pub type PRSDOWNSEL_W<'a> = crate::FieldWriter<'a, u32, CALCTRL_SPEC, u8, PRSDOWNSEL_A, 4, 24>;
