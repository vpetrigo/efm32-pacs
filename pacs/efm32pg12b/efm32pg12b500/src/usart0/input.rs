...
pub type RXPRSSEL_W<'a> = crate::FieldWriter<'a, u32, INPUT_SPEC, u8, RXPRSSEL_A, 4, 0>;
impl<'a> RXPRSSEL_W<'a> {
...
pub type CLKPRSSEL_W<'a> = crate::FieldWriter<'a, u32, INPUT_SPEC, u8, CLKPRSSEL_A, 4, 8>;
