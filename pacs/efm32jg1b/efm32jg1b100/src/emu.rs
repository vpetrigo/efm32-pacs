...
pub struct RegisterBlock {
    ...
    pub pwrcfg: crate::Reg<pwrcfg::PWRCFG_SPEC>,
    ...
    pub dcdctiming: crate::Reg<dcdctiming::DCDCTIMING_SPEC>,
    ...
    pub biasconf: crate::Reg<biasconf::BIASCONF_SPEC>,
    _reserved31: [u8; 0x28],
    #[doc = "0x190 - Test Lock Register"]
    pub testlock: crate::Reg<testlock::TESTLOCK_SPEC>,
    _reserved32: [u8; 0x08],
    #[doc = "0x19c - Test Control Register for Regulator and BIAS"]
    pub biastestctrl: crate::Reg<biastestctrl::BIASTESTCTRL_SPEC>,
}
...
pub mod pwrlock;
#[doc = "PWRCFG register accessor: an alias for `Reg<PWRCFG_SPEC>`"]
...
pub mod dcdclnvctrl;
#[doc = "DCDCTIMING register accessor: an alias for `Reg<DCDCTIMING_SPEC>`"]
...
pub mod vmonio0ctrl;
#[doc = "BIASCONF register accessor: an alias for `Reg<BIASCONF_SPEC>`"]
pub type BIASCONF = crate::Reg<biasconf::BIASCONF_SPEC>;
#[doc = "Configurations Related to the Bias"]
pub mod biasconf;
#[doc = "TESTLOCK register accessor: an alias for `Reg<TESTLOCK_SPEC>`"]
pub type TESTLOCK = crate::Reg<testlock::TESTLOCK_SPEC>;
#[doc = "Test Lock Register"]
pub mod testlock;
#[doc = "BIASTESTCTRL register accessor: an alias for `Reg<BIASTESTCTRL_SPEC>`"]
