...
pub type IBTRIMXOCORE_W<'a> = crate::FieldWriter<'a, u32, HFXOSTARTUPCTRL_SPEC, u8, u8, 7, 0>;
...
pub type RESERVED0_W<'a> = crate::FieldWriter<'a, u32, HFXOSTARTUPCTRL_SPEC, u8, u8, 7, 21>;
...
pub type RESERVED1_W<'a> = crate::FieldWriter<'a, u32, HFXOSTARTUPCTRL_SPEC, u8, u8, 4, 28>;
impl R {
