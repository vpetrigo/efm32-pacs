...
pub type TUNING_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 7, 0>;
...
pub type FINETUNING_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 6, 8>;
...
pub type LDOHP_W<'a> = crate::BitWriter<'a, u32, CAL_SPEC, bool, 15>;
...
pub type FREQRANGE_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 5, 16>;
...
pub type CMPBIAS_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 3, 21>;
...
pub type CLKDIV_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, CLKDIV_A, 2, 24>;
impl<'a> CLKDIV_W<'a> {
    #[doc = "Divide by 1."]
    #[inline(always)]
...
pub type CMPSEL_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 2, 26>;
...
pub type IREFTC_W<'a> = crate::FieldWriter<'a, u32, CAL_SPEC, u8, u8, 4, 28>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 28:31 - Tempco Trim on Comparator Current"]
    #[inline(always)]
    pub fn ireftc(&mut self) -> IREFTC_W {
        IREFTC_W::new(self)
    }
