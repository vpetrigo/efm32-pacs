...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, SYNC_CH0_CTRL_SPEC, u8, SIGSEL_A, 3, 0>;
impl<'a> SIGSEL_W<'a> {
    #[doc = "NONE"]
    #[inline(always)]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, SYNC_CH0_CTRL_SPEC, u8, u8, 7, 8>;
impl R {
