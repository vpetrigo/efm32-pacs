...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, ASYNC_CH4_CTRL_SPEC, u8, SIGSEL_A, 3, 0>;
impl<'a> SIGSEL_W<'a> {
    #[doc = "NONE"]
    #[inline(always)]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, ASYNC_CH4_CTRL_SPEC, u8, u8, 7, 8>;
#[doc = "Function Select\n\nValue on reset: 12"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FNSEL_A {
...
pub type FNSEL_W<'a> = crate::FieldWriterSafe<'a, u32, ASYNC_CH4_CTRL_SPEC, u8, FNSEL_A, 4, 16>;
impl<'a> FNSEL_W<'a> {
    #[doc = "Logical 0"]
    #[inline(always)]
...
pub type AUXSEL_W<'a> = crate::FieldWriter<'a, u32, ASYNC_CH4_CTRL_SPEC, u8, u8, 4, 24>;
impl R {
