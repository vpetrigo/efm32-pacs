...
pub type SCOMP_W<'a> = crate::FieldWriter<'a, u32, ST41_ARC_SPEC, u8, u8, 4, 0>;
#[doc = "Field `SMASK` reader - Sensor mask"]
pub type SMASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SMASK` writer - Sensor mask"]
pub type SMASK_W<'a> = crate::FieldWriter<'a, u32, ST41_ARC_SPEC, u8, u8, 4, 4>;
...
pub type CURSTATE_W<'a> = crate::FieldWriter<'a, u32, ST41_ARC_SPEC, u8, u8, 5, 8>;
...
pub type PRSACT_W<'a> = crate::FieldWriter<'a, u32, ST41_ARC_SPEC, u8, PRSACT_A, 3, 13>;
impl<'a> PRSACT_W<'a> {
...
pub type NEXTSTATE_W<'a> = crate::FieldWriter<'a, u32, ST41_ARC_SPEC, u8, u8, 5, 16>;
#[doc = "Field `SETIF` reader - Set interrupt flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set interrupt flag"]
pub type SETIF_W<'a> = crate::BitWriter<'a, u32, ST41_ARC_SPEC, bool, 21>;
impl R {
