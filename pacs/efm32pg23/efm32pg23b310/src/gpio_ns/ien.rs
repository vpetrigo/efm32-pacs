...
pub type EXTIEN0_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 0>;
...
pub type EXTIEN1_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 1>;
...
pub type EXTIEN2_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 2>;
...
pub type EXTIEN3_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 3>;
...
pub type EXTIEN4_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 4>;
...
pub type EXTIEN5_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 5>;
...
pub type EXTIEN6_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 6>;
...
pub type EXTIEN7_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 7>;
...
pub type EXTIEN8_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 8>;
...
pub type EXTIEN9_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 9>;
...
pub type EXTIEN10_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 10>;
...
pub type EXTIEN11_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 11>;
...
pub type EM4WUIEN0_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 16>;
...
pub type EM4WUIEN1_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 17>;
...
pub type EM4WUIEN2_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 18>;
...
pub type EM4WUIEN3_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 19>;
...
pub type EM4WUIEN4_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 20>;
...
pub type EM4WUIEN5_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 21>;
...
pub type EM4WUIEN6_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 22>;
...
pub type EM4WUIEN7_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 23>;
...
pub type EM4WUIEN8_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 24>;
...
pub type EM4WUIEN9_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 25>;
...
pub type EM4WUIEN10_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 26>;
...
pub type EM4WUIEN11_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 27>;
impl R {
...
impl W {
    #[doc = "Bit 0 - External Pin Enable"]
    #[inline(always)]
    pub fn extien0(&mut self) -> EXTIEN0_W {
        EXTIEN0_W::new(self)
    }
    #[doc = "Bit 1 - External Pin Enable"]
    #[inline(always)]
    pub fn extien1(&mut self) -> EXTIEN1_W {
        EXTIEN1_W::new(self)
    }
    #[doc = "Bit 2 - External Pin Enable"]
    #[inline(always)]
    pub fn extien2(&mut self) -> EXTIEN2_W {
        EXTIEN2_W::new(self)
    }
    #[doc = "Bit 3 - External Pin Enable"]
    #[inline(always)]
    pub fn extien3(&mut self) -> EXTIEN3_W {
        EXTIEN3_W::new(self)
    }
    #[doc = "Bit 4 - External Pin Enable"]
    #[inline(always)]
    pub fn extien4(&mut self) -> EXTIEN4_W {
        EXTIEN4_W::new(self)
    }
    #[doc = "Bit 5 - External Pin Enable"]
    #[inline(always)]
    pub fn extien5(&mut self) -> EXTIEN5_W {
        EXTIEN5_W::new(self)
    }
    #[doc = "Bit 6 - External Pin Enable"]
    #[inline(always)]
    pub fn extien6(&mut self) -> EXTIEN6_W {
        EXTIEN6_W::new(self)
    }
    #[doc = "Bit 7 - External Pin Enable"]
    #[inline(always)]
    pub fn extien7(&mut self) -> EXTIEN7_W {
        EXTIEN7_W::new(self)
    }
    #[doc = "Bit 8 - External Pin Enable"]
    #[inline(always)]
    pub fn extien8(&mut self) -> EXTIEN8_W {
        EXTIEN8_W::new(self)
    }
    #[doc = "Bit 9 - External Pin Enable"]
    #[inline(always)]
    pub fn extien9(&mut self) -> EXTIEN9_W {
        EXTIEN9_W::new(self)
    }
    #[doc = "Bit 10 - External Pin Enable"]
    #[inline(always)]
    pub fn extien10(&mut self) -> EXTIEN10_W {
        EXTIEN10_W::new(self)
    }
    #[doc = "Bit 11 - External Pin Enable"]
    #[inline(always)]
    pub fn extien11(&mut self) -> EXTIEN11_W {
        EXTIEN11_W::new(self)
    }
    #[doc = "Bit 16 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien0(&mut self) -> EM4WUIEN0_W {
        EM4WUIEN0_W::new(self)
    }
    #[doc = "Bit 17 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien1(&mut self) -> EM4WUIEN1_W {
        EM4WUIEN1_W::new(self)
    }
    #[doc = "Bit 18 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien2(&mut self) -> EM4WUIEN2_W {
        EM4WUIEN2_W::new(self)
    }
    #[doc = "Bit 19 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien3(&mut self) -> EM4WUIEN3_W {
        EM4WUIEN3_W::new(self)
    }
    #[doc = "Bit 20 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien4(&mut self) -> EM4WUIEN4_W {
        EM4WUIEN4_W::new(self)
    }
    #[doc = "Bit 21 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien5(&mut self) -> EM4WUIEN5_W {
        EM4WUIEN5_W::new(self)
    }
    #[doc = "Bit 22 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien6(&mut self) -> EM4WUIEN6_W {
        EM4WUIEN6_W::new(self)
    }
    #[doc = "Bit 23 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien7(&mut self) -> EM4WUIEN7_W {
        EM4WUIEN7_W::new(self)
    }
    #[doc = "Bit 24 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien8(&mut self) -> EM4WUIEN8_W {
        EM4WUIEN8_W::new(self)
    }
    #[doc = "Bit 25 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien9(&mut self) -> EM4WUIEN9_W {
        EM4WUIEN9_W::new(self)
    }
    #[doc = "Bit 26 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien10(&mut self) -> EM4WUIEN10_W {
        EM4WUIEN10_W::new(self)
    }
    #[doc = "Bit 27 - EM4 Wake Up Interrupt En"]
    #[inline(always)]
    pub fn em4wuien11(&mut self) -> EM4WUIEN11_W {
