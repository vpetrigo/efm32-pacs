...
pub type MODE0_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEH_SPEC, u8, MODE0_A, 4, 0>;
impl<'a> MODE0_W<'a> {
...
pub type MODE1_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEH_SPEC, u8, MODE1_A, 4, 4>;
impl<'a> MODE1_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
