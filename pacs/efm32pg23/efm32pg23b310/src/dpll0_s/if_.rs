...
pub type LOCK_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 0>;
...
pub type LOCKFAILLOW_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 1>;
...
pub type LOCKFAILHIGH_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 2>;
impl R {
