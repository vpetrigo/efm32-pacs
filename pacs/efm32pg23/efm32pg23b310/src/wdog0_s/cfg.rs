...
pub type EM1RUN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, EM1RUN_A, 1>;
impl<'a> EM1RUN_W<'a> {
...
pub type EM2RUN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, EM2RUN_A, 2>;
impl<'a> EM2RUN_W<'a> {
...
pub type EM3RUN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, EM3RUN_A, 3>;
impl<'a> EM3RUN_W<'a> {
...
pub type EM4BLOCK_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, EM4BLOCK_A, 4>;
impl<'a> EM4BLOCK_W<'a> {
...
pub type DEBUGRUN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, DEBUGRUN_A, 5>;
impl<'a> DEBUGRUN_W<'a> {
...
impl W {
    ...
    #[doc = "Bit 1 - EM1 Run"]
    #[inline(always)]
    pub fn em1run(&mut self) -> EM1RUN_W {
        EM1RUN_W::new(self)
    }
    #[doc = "Bit 2 - EM2 Run"]
    #[inline(always)]
