...
pub type UF_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 1>;
...
pub type DIRCHG_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 2>;
...
pub type CC1_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 5>;
...
pub type CC2_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 6>;
...
pub type ICFWLFULL0_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 16>;
...
pub type ICFWLFULL1_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 17>;
...
pub type ICFWLFULL2_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 18>;
...
pub type ICFOF0_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 20>;
...
pub type ICFOF1_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 21>;
...
pub type ICFOF2_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 22>;
...
pub type ICFUF0_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 24>;
...
pub type ICFUF1_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 25>;
...
pub type ICFUF2_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 26>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 16 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull0(&mut self) -> ICFWLFULL0_W {
        ICFWLFULL0_W::new(self)
    }
    #[doc = "Bit 17 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull1(&mut self) -> ICFWLFULL1_W {
        ICFWLFULL1_W::new(self)
    }
    #[doc = "Bit 18 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull2(&mut self) -> ICFWLFULL2_W {
        ICFWLFULL2_W::new(self)
    }
    #[doc = "Bit 20 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof0(&mut self) -> ICFOF0_W {
        ICFOF0_W::new(self)
    }
    #[doc = "Bit 21 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof1(&mut self) -> ICFOF1_W {
        ICFOF1_W::new(self)
    }
    #[doc = "Bit 22 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof2(&mut self) -> ICFOF2_W {
        ICFOF2_W::new(self)
    }
    #[doc = "Bit 24 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf0(&mut self) -> ICFUF0_W {
        ICFUF0_W::new(self)
    }
    #[doc = "Bit 25 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf1(&mut self) -> ICFUF1_W {
        ICFUF1_W::new(self)
    }
    #[doc = "Bit 26 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf2(&mut self) -> ICFUF2_W {
        ICFUF2_W::new(self)
    }
