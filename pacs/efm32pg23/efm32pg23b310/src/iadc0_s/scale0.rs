...
pub type OFFSET_W<'a> = crate::FieldWriter<'a, u32, SCALE0_SPEC, u32, u32, 18, 0>;
...
pub type GAIN13LSB_W<'a> = crate::FieldWriter<'a, u32, SCALE0_SPEC, u16, u16, 13, 18>;
#[doc = "Gain 3 MSBs\n\nValue on reset: 1"]
...
pub type GAIN3MSB_W<'a> = crate::BitWriter<'a, u32, SCALE0_SPEC, GAIN3MSB_A, 31>;
impl<'a> GAIN3MSB_W<'a> {
