...
pub type EM4ENTRY_W<'a> = crate::FieldWriter<'a, u32, EM4CTRL_SPEC, u8, u8, 2, 0>;
...
pub type BOD3SENSEEM4WU_W<'a> = crate::BitWriter<'a, u32, EM4CTRL_SPEC, bool, 8>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 8 - Set BOD3SENSE as EM4 wakeup"]
    #[inline(always)]
    pub fn bod3senseem4wu(&mut self) -> BOD3SENSEEM4WU_W {
