...
pub type EXTIF10_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 10>;
...
pub type EXTIF11_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 11>;
#[doc = "Field `EM4WU` reader - EM4 wake up"]
pub type EM4WU_R = crate::FieldReader<u16, u16>;
#[doc = "Field `EM4WU` writer - EM4 wake up"]
pub type EM4WU_W<'a> = crate::FieldWriter<'a, u32, IF_SPEC, u16, u16, 12, 16>;
impl R {
...
impl W {
    #[doc = "Bit 0 - External Pin Flag"]
    #[inline(always)]
    pub fn extif0(&mut self) -> EXTIF0_W {
        EXTIF0_W::new(self)
    }
    #[doc = "Bit 1 - External Pin Flag"]
    #[inline(always)]
    pub fn extif1(&mut self) -> EXTIF1_W {
        EXTIF1_W::new(self)
    }
    #[doc = "Bit 2 - External Pin Flag"]
    #[inline(always)]
    pub fn extif2(&mut self) -> EXTIF2_W {
        EXTIF2_W::new(self)
    }
    #[doc = "Bit 3 - External Pin Flag"]
    #[inline(always)]
    pub fn extif3(&mut self) -> EXTIF3_W {
        EXTIF3_W::new(self)
    }
    #[doc = "Bit 4 - External Pin Flag"]
    #[inline(always)]
    pub fn extif4(&mut self) -> EXTIF4_W {
        EXTIF4_W::new(self)
    }
    #[doc = "Bit 5 - External Pin Flag"]
    #[inline(always)]
    pub fn extif5(&mut self) -> EXTIF5_W {
        EXTIF5_W::new(self)
    }
    #[doc = "Bit 6 - External Pin Flag"]
    #[inline(always)]
    pub fn extif6(&mut self) -> EXTIF6_W {
        EXTIF6_W::new(self)
    }
    #[doc = "Bit 7 - External Pin Flag"]
    #[inline(always)]
    pub fn extif7(&mut self) -> EXTIF7_W {
        EXTIF7_W::new(self)
    }
    #[doc = "Bit 8 - External Pin Flag"]
    #[inline(always)]
    pub fn extif8(&mut self) -> EXTIF8_W {
        EXTIF8_W::new(self)
    }
    #[doc = "Bit 9 - External Pin Flag"]
    #[inline(always)]
    pub fn extif9(&mut self) -> EXTIF9_W {
        EXTIF9_W::new(self)
    }
    #[doc = "Bit 10 - External Pin Flag"]
    #[inline(always)]
    pub fn extif10(&mut self) -> EXTIF10_W {
        EXTIF10_W::new(self)
    }
    #[doc = "Bit 11 - External Pin Flag"]
    #[inline(always)]
    pub fn extif11(&mut self) -> EXTIF11_W {
        EXTIF11_W::new(self)
    }
    #[doc = "Bits 16:27 - EM4 wake up"]
    #[inline(always)]
