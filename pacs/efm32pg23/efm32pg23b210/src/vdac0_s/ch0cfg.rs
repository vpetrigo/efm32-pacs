...
pub type CONVMODE_W<'a> = crate::BitWriter<'a, u32, CH0CFG_SPEC, CONVMODE_A, 0>;
impl<'a> CONVMODE_W<'a> {
...
pub type POWERMODE_W<'a> = crate::BitWriter<'a, u32, CH0CFG_SPEC, POWERMODE_A, 2>;
...
pub type TRIGMODE_W<'a> = crate::FieldWriter<'a, u32, CH0CFG_SPEC, u8, TRIGMODE_A, 3, 4>;
impl<'a> TRIGMODE_W<'a> {
...
pub type REFRESHSOURCE_W<'a> =
    crate::FieldWriterSafe<'a, u32, CH0CFG_SPEC, u8, REFRESHSOURCE_A, 2, 8>;
...
pub type FIFODVL_W<'a> = crate::FieldWriter<'a, u32, CH0CFG_SPEC, u8, u8, 2, 11>;
...
pub type HIGHCAPLOADEN_W<'a> = crate::BitWriter<'a, u32, CH0CFG_SPEC, bool, 14>;
...
pub type KEEPWARM_W<'a> = crate::BitWriter<'a, u32, CH0CFG_SPEC, bool, 16>;
impl R {
