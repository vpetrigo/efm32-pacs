...
pub type MODE0_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE0_A, 4, 0>;
impl<'a> MODE0_W<'a> {
...
pub type MODE1_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE1_A, 4, 4>;
impl<'a> MODE1_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE2_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE2_A, 4, 8>;
impl<'a> MODE2_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE3_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE3_A, 4, 12>;
impl<'a> MODE3_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE4_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE4_A, 4, 16>;
impl<'a> MODE4_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE5_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE5_A, 4, 20>;
impl<'a> MODE5_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE6_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE6_A, 4, 24>;
impl<'a> MODE6_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE7_W<'a> = crate::FieldWriterSafe<'a, u32, PORTC_MODEL_SPEC, u8, MODE7_A, 4, 28>;
impl<'a> MODE7_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
