...
pub type MODE1_W<'a> = crate::FieldWriterSafe<'a, u32, PORTA_MODEH_SPEC, u8, MODE1_A, 4, 4>;
impl<'a> MODE1_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE2_W<'a> = crate::FieldWriterSafe<'a, u32, PORTA_MODEH_SPEC, u8, MODE2_A, 4, 8>;
impl<'a> MODE2_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
