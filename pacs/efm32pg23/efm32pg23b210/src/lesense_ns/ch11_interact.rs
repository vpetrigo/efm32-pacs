...
pub type EXMODE_W<'a> = crate::FieldWriterSafe<'a, u32, CH11_INTERACT_SPEC, u8, EXMODE_A, 2, 16>;
impl<'a> EXMODE_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type ALTEX_W<'a> = crate::BitWriter<'a, u32, CH11_INTERACT_SPEC, bool, 18>;
...
pub type SAMPLECLK_W<'a> = crate::BitWriter<'a, u32, CH11_INTERACT_SPEC, SAMPLECLK_A, 19>;
...
pub type EXCLK_W<'a> = crate::BitWriter<'a, u32, CH11_INTERACT_SPEC, EXCLK_A, 20>;
impl<'a> EXCLK_W<'a> {
    #[doc = "LFACLK will be used for timing"]
    #[inline(always)]
    pub fn lfaclk(self) -> &'a mut W {
...
pub type SETIF_W<'a> = crate::FieldWriter<'a, u32, CH11_INTERACT_SPEC, u8, SETIF_A, 3, 21>;
impl<'a> SETIF_W<'a> {
...
pub type OFFSET_W<'a> = crate::FieldWriter<'a, u32, CH11_INTERACT_SPEC, u8, u8, 4, 24>;
...
pub type SAMPLE_W<'a> = crate::FieldWriterSafe<'a, u32, CH11_INTERACT_SPEC, u8, SAMPLE_A, 2, 28>;
impl<'a> SAMPLE_W<'a> {
    #[doc = "ACMPCOUNT"]
    #[inline(always)]
