...
pub type DECODE_W<'a> = crate::BitWriter<'a, u32, CH7_EVALCFG_SPEC, bool, 2>;
...
pub type COMP_W<'a> = crate::BitWriter<'a, u32, CH7_EVALCFG_SPEC, COMP_A, 3>;
impl<'a> COMP_W<'a> {
...
pub type STRSAMPLE_W<'a> = crate::FieldWriter<'a, u32, CH7_EVALCFG_SPEC, u8, STRSAMPLE_A, 2, 4>;
...
pub type SCANRESINV_W<'a> = crate::BitWriter<'a, u32, CH7_EVALCFG_SPEC, bool, 6>;
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CH7_EVALCFG_SPEC, u8, MODE_A, 2, 8>;
impl<'a> MODE_W<'a> {
