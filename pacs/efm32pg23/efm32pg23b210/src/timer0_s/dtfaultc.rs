...
pub type DTLOCKUPFC_W<'a> = crate::BitWriter<'a, u32, DTFAULTC_SPEC, bool, 3>;
#[doc = "Field `DTEM23FC` writer - DTI EM23 Fault Clear"]
pub type DTEM23FC_W<'a> = crate::BitWriter<'a, u32, DTFAULTC_SPEC, bool, 4>;
impl W {
    ...
    #[inline(always)]
    pub fn dtlockupfc(&mut self) -> DTLOCKUPFC_W {
        DTLOCKUPFC_W::new(self)
    }
    #[doc = "Bit 4 - DTI EM23 Fault Clear"]
    #[inline(always)]
    pub fn dtem23fc(&mut self) -> DTEM23FC_W {
        DTEM23FC_W::new(self)
    }
