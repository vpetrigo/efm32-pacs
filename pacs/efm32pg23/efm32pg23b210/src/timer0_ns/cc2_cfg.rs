...
pub type MODE_W<'a> = crate::FieldWriterSafe<'a, u32, CC2_CFG_SPEC, u8, MODE_A, 2, 0>;
impl<'a> MODE_W<'a> {
...
pub type COIST_W<'a> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, bool, 4>;
#[doc = "Input Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum INSEL_A {
...
pub type INSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CC2_CFG_SPEC, u8, INSEL_A, 2, 17>;
impl<'a> INSEL_W<'a> {
...
pub type PRSCONF_W<'a> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, PRSCONF_A, 19>;
impl<'a> PRSCONF_W<'a> {
...
pub type FILT_W<'a> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, FILT_A, 20>;
impl<'a> FILT_W<'a> {
...
pub type ICFWL_W<'a> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, bool, 21>;
impl R {
