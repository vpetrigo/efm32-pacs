...
pub type FAILDETEN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 4>;
...
pub type FAILDETEM4WUEN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 5>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 4 - LFXO Failure Detection Enable"]
    #[inline(always)]
    pub fn faildeten(&mut self) -> FAILDETEN_W {
        FAILDETEN_W::new(self)
    }
    #[doc = "Bit 5 - LFXO Failure Detection EM4WU Enable"]
    #[inline(always)]
    pub fn faildetem4wuen(&mut self) -> FAILDETEM4WUEN_W {
