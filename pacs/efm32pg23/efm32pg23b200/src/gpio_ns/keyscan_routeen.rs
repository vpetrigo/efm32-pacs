...
pub type COLOUT0PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 0>;
...
pub type COLOUT1PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 1>;
...
pub type COLOUT2PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 2>;
...
pub type COLOUT3PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 3>;
...
pub type COLOUT4PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 4>;
...
pub type COLOUT5PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 5>;
...
pub type COLOUT6PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 6>;
...
pub type COLOUT7PEN_W<'a> = crate::BitWriter<'a, u32, KEYSCAN_ROUTEEN_SPEC, bool, 7>;
impl R {
...
impl W {
    #[doc = "Bit 0 - COLOUT0 pin enable control bit"]
    #[inline(always)]
    pub fn colout0pen(&mut self) -> COLOUT0PEN_W {
        COLOUT0PEN_W::new(self)
    }
    #[doc = "Bit 1 - COLOUT1 pin enable control bit"]
    #[inline(always)]
    pub fn colout1pen(&mut self) -> COLOUT1PEN_W {
        COLOUT1PEN_W::new(self)
    }
    #[doc = "Bit 2 - COLOUT2 pin enable control bit"]
    #[inline(always)]
    pub fn colout2pen(&mut self) -> COLOUT2PEN_W {
        COLOUT2PEN_W::new(self)
    }
    #[doc = "Bit 3 - COLOUT3 pin enable control bit"]
    #[inline(always)]
    pub fn colout3pen(&mut self) -> COLOUT3PEN_W {
        COLOUT3PEN_W::new(self)
    }
    #[doc = "Bit 4 - COLOUT4 pin enable control bit"]
    #[inline(always)]
    pub fn colout4pen(&mut self) -> COLOUT4PEN_W {
        COLOUT4PEN_W::new(self)
    }
    #[doc = "Bit 5 - COLOUT5 pin enable control bit"]
    #[inline(always)]
    pub fn colout5pen(&mut self) -> COLOUT5PEN_W {
        COLOUT5PEN_W::new(self)
    }
    #[doc = "Bit 6 - COLOUT6 pin enable control bit"]
    #[inline(always)]
    pub fn colout6pen(&mut self) -> COLOUT6PEN_W {
        COLOUT6PEN_W::new(self)
    }
    #[doc = "Bit 7 - COLOUT7 pin enable control bit"]
    #[inline(always)]
    pub fn colout7pen(&mut self) -> COLOUT7PEN_W {
