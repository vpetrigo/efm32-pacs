...
pub type MODE4_W<'a> = crate::FieldWriterSafe<'a, u32, PORTD_MODEL_SPEC, u8, MODE4_A, 4, 16>;
impl<'a> MODE4_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE5_W<'a> = crate::FieldWriterSafe<'a, u32, PORTD_MODEL_SPEC, u8, MODE5_A, 4, 20>;
impl<'a> MODE5_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
