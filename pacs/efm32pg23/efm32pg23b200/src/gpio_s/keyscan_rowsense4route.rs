...
pub type PORT_W<'a> = crate::FieldWriter<'a, u32, KEYSCAN_ROWSENSE4ROUTE_SPEC, u8, u8, 2, 0>;
...
pub type PIN_W<'a> = crate::FieldWriter<'a, u32, KEYSCAN_ROWSENSE4ROUTE_SPEC, u8, u8, 4, 16>;
impl R {
