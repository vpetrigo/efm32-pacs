...
pub type LOADERR_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 11>;
...
pub type CSWU_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 16>;
...
pub type RXTO_W<'a> = crate::BitWriter<'a, u32, IF_SPEC, bool, 25>;
impl R {
