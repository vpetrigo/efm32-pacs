...
pub type DTFA_W<'a> = crate::FieldWriterSafe<'a, u32, DTFCFG_SPEC, u8, DTFA_A, 2, 16>;
impl<'a> DTFA_W<'a> {
...
pub type DTPRS0FEN_W<'a> = crate::BitWriter<'a, u32, DTFCFG_SPEC, bool, 24>;
...
pub type DTPRS1FEN_W<'a> = crate::BitWriter<'a, u32, DTFCFG_SPEC, bool, 25>;
...
pub type DTDBGFEN_W<'a> = crate::BitWriter<'a, u32, DTFCFG_SPEC, bool, 26>;
...
pub type DTLOCKUPFEN_W<'a> = crate::BitWriter<'a, u32, DTFCFG_SPEC, bool, 27>;
...
pub type DTEM23FEN_W<'a> = crate::BitWriter<'a, u32, DTFCFG_SPEC, bool, 28>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 28 - DTI EM23 Fault Enable"]
    #[inline(always)]
    pub fn dtem23fen(&mut self) -> DTEM23FEN_W {
