...
pub type STRUCTTYPE_W<'a> = crate::FieldWriter<'a, u32, CH6_CTRL_SPEC, u8, STRUCTTYPE_A, 2, 0>;
impl<'a> STRUCTTYPE_W<'a> {
...
pub type DONEIEN_W<'a> = crate::BitWriter<'a, u32, CH6_CTRL_SPEC, bool, 20>;
...
pub type REQMODE_W<'a> = crate::BitWriter<'a, u32, CH6_CTRL_SPEC, REQMODE_A, 21>;
impl<'a> REQMODE_W<'a> {
...
impl W {
    #[doc = "Bits 0:1 - DMA Structure Type"]
    #[inline(always)]
    pub fn structtype(&mut self) -> STRUCTTYPE_W {
    ...
    #[doc = "Bit 20 - DMA Operation Done Interrupt Flag Set En"]
    #[inline(always)]
    pub fn doneien(&mut self) -> DONEIEN_W {
        DONEIEN_W::new(self)
    }
    #[doc = "Bit 21 - DMA Request Transfer Mode Select"]
    #[inline(always)]
