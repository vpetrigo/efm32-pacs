...
pub struct R(crate::R<COMPA_COMP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COMPA_COMP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COMPA_COMP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COMPA_COMP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `COMPA_COMP` writer"]
pub struct W(crate::W<COMPA_COMP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<COMPA_COMP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<COMPA_COMP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<COMPA_COMP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMP_W<'a> = crate::FieldWriter<'a, u32, COMPA_COMP_SPEC, u32, u32, 24, 0>;
impl R {
