...
pub type CHDONE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CHDONE` writer - DMA Channel Linking or Done"]
pub type CHDONE_W<'a> = crate::FieldWriter<'a, u32, CHDONE_SPEC, u32, u32, 24, 0>;
impl R {
    #[doc = "Bits 0:23 - DMA Channel Linking or Done"]
    #[inline(always)]
    pub fn chdone(&self) -> CHDONE_R {
        CHDONE_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - DMA Channel Linking or Done"]
