...
pub struct R(crate::R<CH11_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH11_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH11_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH11_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH11_CFG` writer"]
pub struct W(crate::W<CH11_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH11_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH11_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH11_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ARBSLOTS_W<'a> = crate::FieldWriterSafe<'a, u32, CH11_CFG_SPEC, u8, ARBSLOTS_A, 2, 16>;
impl<'a> ARBSLOTS_W<'a> {
...
pub type SRCINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH11_CFG_SPEC, bool, 20>;
...
pub type DSTINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH11_CFG_SPEC, bool, 21>;
impl R {
