...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, CH14_CTRL_SPEC, u8, u8, 3, 0>;
#[doc = "Source Select\n\nValue on reset: 0"]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, CH14_CTRL_SPEC, u8, SOURCESEL_A, 7, 8>;
...
pub type EDSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CH14_CTRL_SPEC, u8, EDSEL_A, 2, 20>;
impl<'a> EDSEL_W<'a> {
...
pub type ASYNC_W<'a> = crate::BitWriter<'a, u32, CH14_CTRL_SPEC, bool, 30>;
impl R {
