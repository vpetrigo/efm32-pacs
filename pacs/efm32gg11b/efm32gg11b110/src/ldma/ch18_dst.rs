...
pub struct R(crate::R<CH18_DST_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH18_DST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH18_DST_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH18_DST_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH18_DST` writer"]
pub struct W(crate::W<CH18_DST_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH18_DST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH18_DST_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH18_DST_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DSTADDR_W<'a> = crate::FieldWriter<'a, u32, CH18_DST_SPEC, u32, u32, 32, 0>;
impl R {
