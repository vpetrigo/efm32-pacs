...
pub struct R(crate::R<CH12_REQSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH12_REQSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH12_REQSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH12_REQSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH12_REQSEL` writer"]
pub struct W(crate::W<CH12_REQSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH12_REQSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH12_REQSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH12_REQSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, CH12_REQSEL_SPEC, u8, u8, 4, 0>;
#[doc = "Source Select\n\nValue on reset: 0"]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, CH12_REQSEL_SPEC, u8, SOURCESEL_A, 6, 16>;
