...
pub type REQDIS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REQDIS` writer - DMA Request Disables"]
pub type REQDIS_W<'a> = crate::FieldWriter<'a, u32, REQDIS_SPEC, u32, u32, 24, 0>;
impl R {
    #[doc = "Bits 0:23 - DMA Request Disables"]
    #[inline(always)]
    pub fn reqdis(&self) -> REQDIS_R {
        REQDIS_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - DMA Request Disables"]
