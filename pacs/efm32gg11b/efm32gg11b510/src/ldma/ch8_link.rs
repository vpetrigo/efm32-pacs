...
pub struct R(crate::R<CH8_LINK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH8_LINK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH8_LINK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH8_LINK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH8_LINK` writer"]
pub struct W(crate::W<CH8_LINK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH8_LINK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH8_LINK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH8_LINK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LINK_W<'a> = crate::BitWriter<'a, u32, CH8_LINK_SPEC, bool, 1>;
...
pub type LINKADDR_W<'a> = crate::FieldWriter<'a, u32, CH8_LINK_SPEC, u32, u32, 30, 2>;
impl R {
