...
pub struct R(crate::R<ETMPIDR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETMPIDR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETMPIDR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETMPIDR0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Peripheral ID0 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [etmpidr0](index.html) module"]
