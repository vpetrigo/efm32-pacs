...
pub struct R(crate::R<RXIPCKERRS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXIPCKERRS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXIPCKERRS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXIPCKERRS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXIPCKERRS` writer"]
pub struct W(crate::W<RXIPCKERRS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXIPCKERRS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXIPCKERRS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXIPCKERRS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COUNT_W<'a> = crate::FieldWriter<'a, u32, RXIPCKERRS_SPEC, u8, u8, 8, 0>;
impl R {
