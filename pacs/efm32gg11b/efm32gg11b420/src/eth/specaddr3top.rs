...
pub type ADDR_W<'a> = crate::FieldWriter<'a, u32, SPECADDR3TOP_SPEC, u16, u16, 16, 0>;
...
pub type FILTERTYPE_W<'a> = crate::BitWriter<'a, u32, SPECADDR3TOP_SPEC, bool, 16>;
...
pub type FILTERBYTEMASK_W<'a> = crate::FieldWriter<'a, u32, SPECADDR3TOP_SPEC, u8, u8, 6, 24>;
impl R {
