...
pub struct R(crate::R<LATECOLS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LATECOLS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LATECOLS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LATECOLS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LATECOLS` writer"]
pub struct W(crate::W<LATECOLS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LATECOLS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LATECOLS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LATECOLS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COUNT_W<'a> = crate::FieldWriter<'a, u32, LATECOLS_SPEC, u16, u16, 10, 0>;
impl R {
...
#[doc = "Late Collisions\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [latecols](index.html) module"]
