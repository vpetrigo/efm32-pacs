...
pub struct R(crate::R<CH20_LOOP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH20_LOOP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH20_LOOP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH20_LOOP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH20_LOOP` writer"]
pub struct W(crate::W<CH20_LOOP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH20_LOOP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH20_LOOP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH20_LOOP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOOPCNT_W<'a> = crate::FieldWriter<'a, u32, CH20_LOOP_SPEC, u8, u8, 8, 0>;
impl R {
