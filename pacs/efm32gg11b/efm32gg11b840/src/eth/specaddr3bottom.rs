...
pub struct R(crate::R<SPECADDR3BOTTOM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPECADDR3BOTTOM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPECADDR3BOTTOM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPECADDR3BOTTOM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPECADDR3BOTTOM` writer"]
pub struct W(crate::W<SPECADDR3BOTTOM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPECADDR3BOTTOM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPECADDR3BOTTOM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPECADDR3BOTTOM_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDR_W<'a> = crate::FieldWriter<'a, u32, SPECADDR3BOTTOM_SPEC, u32, u32, 32, 0>;
impl R {
