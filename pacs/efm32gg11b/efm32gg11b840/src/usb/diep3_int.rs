...
pub struct R(crate::R<DIEP3_INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP3_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP3_INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP3_INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIEP3_INT` writer"]
pub struct W(crate::W<DIEP3_INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIEP3_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIEP3_INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIEP3_INT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERCOMPL_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 0>;
...
pub type EPDISBLD_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 1>;
#[doc = "Field `AHBERR` reader - AHB Error"]
pub type AHBERR_R = crate::BitReader<bool>;
#[doc = "Field `AHBERR` writer - AHB Error"]
pub type AHBERR_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 2>;
...
pub type TIMEOUT_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 3>;
...
pub type INTKNTXFEMP_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 4>;
...
pub type INTKNEPMIS_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 5>;
...
pub type INEPNAKEFF_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 6>;
...
pub type TXFIFOUNDRN_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 8>;
...
pub type PKTDRPSTS_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 11>;
...
pub type BBLEERR_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 12>;
...
pub type NAKINTRPT_W<'a> = crate::BitWriter<'a, u32, DIEP3_INT_SPEC, bool, 13>;
impl R {
