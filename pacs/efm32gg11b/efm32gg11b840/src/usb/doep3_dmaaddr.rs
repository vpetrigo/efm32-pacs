...
pub struct R(crate::R<DOEP3_DMAADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEP3_DMAADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEP3_DMAADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEP3_DMAADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOEP3_DMAADDR` writer"]
pub struct W(crate::W<DOEP3_DMAADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEP3_DMAADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEP3_DMAADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEP3_DMAADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMAADDR_W<'a> = crate::FieldWriter<'a, u32, DOEP3_DMAADDR_SPEC, u32, u32, 32, 0>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
