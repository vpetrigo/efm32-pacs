...
pub struct R(crate::R<DIEP1_DTXFSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIEP1_DTXFSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIEP1_DTXFSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIEP1_DTXFSTS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device IN Endpoint Transmit FIFO Status Register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [diep1_dtxfsts](index.html) module"]
