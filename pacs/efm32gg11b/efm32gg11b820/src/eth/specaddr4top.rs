...
pub struct R(crate::R<SPECADDR4TOP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPECADDR4TOP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPECADDR4TOP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPECADDR4TOP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPECADDR4TOP` writer"]
pub struct W(crate::W<SPECADDR4TOP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPECADDR4TOP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPECADDR4TOP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPECADDR4TOP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDR_W<'a> = crate::FieldWriter<'a, u32, SPECADDR4TOP_SPEC, u16, u16, 16, 0>;
...
pub type FILTERTYPE_W<'a> = crate::BitWriter<'a, u32, SPECADDR4TOP_SPEC, bool, 16>;
...
pub type FILTERBYTEMASK_W<'a> = crate::FieldWriter<'a, u32, SPECADDR4TOP_SPEC, u8, u8, 6, 24>;
impl R {
