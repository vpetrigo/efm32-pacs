...
pub struct R(crate::R<WRTIMING1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WRTIMING1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WRTIMING1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WRTIMING1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WRTIMING1` writer"]
pub struct W(crate::W<WRTIMING1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WRTIMING1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WRTIMING1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WRTIMING1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WRSETUP_W<'a> = crate::FieldWriter<'a, u32, WRTIMING1_SPEC, u8, u8, 3, 0>;
...
pub type WRSTRB_W<'a> = crate::FieldWriter<'a, u32, WRTIMING1_SPEC, u8, u8, 7, 8>;
#[doc = "Field `WRHOLD` reader - Write Hold Time"]
pub type WRHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WRHOLD` writer - Write Hold Time"]
pub type WRHOLD_W<'a> = crate::FieldWriter<'a, u32, WRTIMING1_SPEC, u8, u8, 3, 16>;
...
pub type HALFWE_W<'a> = crate::BitWriter<'a, u32, WRTIMING1_SPEC, bool, 28>;
...
pub type WBUFDIS_W<'a> = crate::BitWriter<'a, u32, WRTIMING1_SPEC, bool, 29>;
impl R {
