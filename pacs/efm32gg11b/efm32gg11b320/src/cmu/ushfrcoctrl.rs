...
pub type FINETUNING_W<'a> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 6, 8>;
...
pub type FREQRANGE_W<'a> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 5, 16>;
...
pub type CMPBIAS_W<'a> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 3, 21>;
...
pub type LDOHP_W<'a> = crate::BitWriter<'a, u32, USHFRCOCTRL_SPEC, bool, 24>;
...
pub type CLKDIV_W<'a> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, CLKDIV_A, 2, 25>;
impl<'a> CLKDIV_W<'a> {
    #[doc = "Divide by 1."]
    #[inline(always)]
...
pub type FINETUNINGEN_W<'a> = crate::BitWriter<'a, u32, USHFRCOCTRL_SPEC, bool, 27>;
...
pub type VREFTC_W<'a> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 4, 28>;
impl R {
