...
pub struct R(crate::R<CH17_SRC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH17_SRC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH17_SRC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH17_SRC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH17_SRC` writer"]
pub struct W(crate::W<CH17_SRC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH17_SRC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH17_SRC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH17_SRC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRCADDR_W<'a> = crate::FieldWriter<'a, u32, CH17_SRC_SPEC, u32, u32, 32, 0>;
impl R {
