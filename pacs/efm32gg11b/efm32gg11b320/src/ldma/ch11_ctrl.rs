...
pub type STRUCTREQ_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 3>;
...
pub type XFERCNT_W<'a> = crate::FieldWriter<'a, u32, CH11_CTRL_SPEC, u16, u16, 11, 4>;
...
pub type BYTESWAP_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 15>;
...
pub type BLOCKSIZE_W<'a> = crate::FieldWriter<'a, u32, CH11_CTRL_SPEC, u8, BLOCKSIZE_A, 4, 16>;
...
pub type DONEIFSEN_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 20>;
...
pub type REQMODE_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 21>;
...
pub type DECLOOPCNT_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 22>;
#[doc = "Field `IGNORESREQ` reader - Ignore Sreq"]
pub type IGNORESREQ_R = crate::BitReader<bool>;
#[doc = "Field `IGNORESREQ` writer - Ignore Sreq"]
pub type IGNORESREQ_W<'a> = crate::BitWriter<'a, u32, CH11_CTRL_SPEC, bool, 23>;
...
pub type SRCINC_W<'a> = crate::FieldWriterSafe<'a, u32, CH11_CTRL_SPEC, u8, SRCINC_A, 2, 24>;
impl<'a> SRCINC_W<'a> {
...
pub type SIZE_W<'a> = crate::FieldWriter<'a, u32, CH11_CTRL_SPEC, u8, SIZE_A, 2, 26>;
impl<'a> SIZE_W<'a> {
...
pub type DSTINC_W<'a> = crate::FieldWriterSafe<'a, u32, CH11_CTRL_SPEC, u8, DSTINC_A, 2, 28>;
impl<'a> DSTINC_W<'a> {
