...
pub type DCLKPERIOD_W<'a> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u16, u16, 12, 0>;
...
pub type TFTSTART_W<'a> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u16, u16, 12, 12>;
...
pub type TFTSETUP_W<'a> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u8, u8, 3, 24>;
#[doc = "Field `TFTHOLD` reader - TFT Hold Time"]
pub type TFTHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TFTHOLD` writer - TFT Hold Time"]
pub type TFTHOLD_W<'a> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u8, u8, 3, 28>;
impl R {
