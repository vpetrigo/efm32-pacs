...
pub type LEUART1_W<'a> = crate::BitWriter<'a, u32, LFBCLKEN0_SPEC, bool, 1>;
#[doc = "Field `SYSTICK` reader - Clock Enable"]
pub type SYSTICK_R = crate::BitReader<bool>;
#[doc = "Field `SYSTICK` writer - Clock Enable"]
pub type SYSTICK_W<'a> = crate::BitWriter<'a, u32, LFBCLKEN0_SPEC, bool, 2>;
...
pub type CSEN_W<'a> = crate::BitWriter<'a, u32, LFBCLKEN0_SPEC, bool, 3>;
impl R {
