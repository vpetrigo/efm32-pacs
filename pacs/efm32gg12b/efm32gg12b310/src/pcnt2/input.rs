...
pub type S0PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S0PRSSEL_A, 4, 0>;
impl<'a> S0PRSSEL_W<'a> {
...
pub type S1PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S1PRSSEL_A, 4, 6>;
impl<'a> S1PRSSEL_W<'a> {
    #[doc = "PRS Channel 0 selected."]
    #[inline(always)]
    pub fn prsch0(self) -> &'a mut W {
