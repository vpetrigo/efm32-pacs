...
pub struct R(crate::R<RDTIMING3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDTIMING3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDTIMING3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDTIMING3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RDTIMING3` writer"]
pub struct W(crate::W<RDTIMING3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RDTIMING3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RDTIMING3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RDTIMING3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RDSETUP_W<'a> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 3, 0>;
...
pub type RDSTRB_W<'a> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 7, 8>;
#[doc = "Field `RDHOLD` reader - Read Hold Time"]
pub type RDHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RDHOLD` writer - Read Hold Time"]
pub type RDHOLD_W<'a> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 3, 16>;
...
pub type HALFRE_W<'a> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, 28>;
...
pub type PREFETCH_W<'a> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, 29>;
...
pub type PAGEMODE_W<'a> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, 30>;
impl R {
