...
pub type ADDRSETUP_W<'a> = crate::FieldWriter<'a, u32, ADDRTIMING3_SPEC, u8, u8, 3, 0>;
...
pub type ADDRHOLD_W<'a> = crate::FieldWriter<'a, u32, ADDRTIMING3_SPEC, u8, u8, 3, 8>;
...
pub type HALFALE_W<'a> = crate::BitWriter<'a, u32, ADDRTIMING3_SPEC, bool, 28>;
impl R {
