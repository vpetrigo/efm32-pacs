...
pub type RDSETUP_W<'a> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 3, 0>;
...
pub type RDSTRB_W<'a> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 7, 8>;
#[doc = "Field `RDHOLD` reader - Read Hold Time"]
pub type RDHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RDHOLD` writer - Read Hold Time"]
pub type RDHOLD_W<'a> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 3, 16>;
...
pub type HALFRE_W<'a> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, 28>;
...
pub type PREFETCH_W<'a> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, 29>;
...
pub type PAGEMODE_W<'a> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, 30>;
impl R {
