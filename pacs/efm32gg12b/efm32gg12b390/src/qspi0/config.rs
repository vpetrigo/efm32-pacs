...
pub type ENBDEVHOLD_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 4>;
...
pub type ENBDEVRST_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 5>;
...
pub type DEVRSTCONFIG_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 6>;
