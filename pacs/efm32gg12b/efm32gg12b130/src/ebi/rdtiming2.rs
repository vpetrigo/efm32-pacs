...
pub type RDSETUP_W<'a> = crate::FieldWriter<'a, u32, RDTIMING2_SPEC, u8, u8, 3, 0>;
...
pub type RDSTRB_W<'a> = crate::FieldWriter<'a, u32, RDTIMING2_SPEC, u8, u8, 7, 8>;
#[doc = "Field `RDHOLD` reader - Read Hold Time"]
pub type RDHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RDHOLD` writer - Read Hold Time"]
pub type RDHOLD_W<'a> = crate::FieldWriter<'a, u32, RDTIMING2_SPEC, u8, u8, 3, 16>;
