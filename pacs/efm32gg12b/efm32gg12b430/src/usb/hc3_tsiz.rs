...
pub struct R(crate::R<HC3_TSIZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HC3_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HC3_TSIZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HC3_TSIZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HC3_TSIZ` writer"]
pub struct W(crate::W<HC3_TSIZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HC3_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HC3_TSIZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HC3_TSIZ_SPEC>) -> Self {
        W(writer)
    }
}
