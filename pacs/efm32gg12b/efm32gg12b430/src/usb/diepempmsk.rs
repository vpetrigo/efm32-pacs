...
pub type INEPTXFEMPMSK_R = crate::FieldReader<u16, u16>;
#[doc = "Field `INEPTXFEMPMSK` writer - IN EP Tx FIFO Empty Interrupt Mask Bits"]
pub type INEPTXFEMPMSK_W<'a> = crate::FieldWriter<'a, u32, DIEPEMPMSK_SPEC, u16, u16, 16, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - IN EP Tx FIFO Empty Interrupt Mask Bits"]
    #[inline(always)]
    pub fn ineptxfempmsk(&mut self) -> INEPTXFEMPMSK_W {
