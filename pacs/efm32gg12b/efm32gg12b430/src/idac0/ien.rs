...
pub type CURSTABLE_R = crate::BitReader<bool>;
#[doc = "Field `CURSTABLE` writer - CURSTABLE Interrupt Enable"]
pub type CURSTABLE_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 0>;
...
pub type APORTCONFLICT_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 1>;
impl R {
