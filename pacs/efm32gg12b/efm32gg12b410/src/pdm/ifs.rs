...
pub type DV_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 0>;
#[doc = "Field `DVL` writer - Set DVL Interrupt Flag"]
pub type DVL_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 1>;
#[doc = "Field `OF` writer - Set OF Interrupt Flag"]
pub type OF_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 2>;
#[doc = "Field `UF` writer - Set UF Interrupt Flag"]
pub type UF_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 3>;
impl W {
