...
impl PERIPHID_R {
    ...
    pub fn variant(&self) -> Option<PERIPHID_A> {
        match self.bits {
            ...
            3 => Some(PERIPHID_A::ADC0),
            4 => Some(PERIPHID_A::ADC1),
            5 => Some(PERIPHID_A::CAN0),
            6 => Some(PERIPHID_A::CAN1),
            7 => Some(PERIPHID_A::CMU),
            8 => Some(PERIPHID_A::CRYOTIMER),
            9 => Some(PERIPHID_A::CRYPTO0),
            10 => Some(PERIPHID_A::CSEN),
            11 => Some(PERIPHID_A::VDAC0),
            12 => Some(PERIPHID_A::PRS),
            13 => Some(PERIPHID_A::EBI),
            14 => Some(PERIPHID_A::EMU),
            15 => Some(PERIPHID_A::FPUEH),
            ...
            22 => Some(PERIPHID_A::LCD),
            23 => Some(PERIPHID_A::LDMA),
            24 => Some(PERIPHID_A::LESENSE),
            25 => Some(PERIPHID_A::LETIMER0),
            26 => Some(PERIPHID_A::LETIMER1),
            27 => Some(PERIPHID_A::LEUART0),
            28 => Some(PERIPHID_A::LEUART1),
            32 => Some(PERIPHID_A::PCNT0),
            33 => Some(PERIPHID_A::PCNT1),
            34 => Some(PERIPHID_A::PCNT2),
            35 => Some(PERIPHID_A::PDM),
            36 => Some(PERIPHID_A::QSPI0),
            37 => Some(PERIPHID_A::RMU),
            38 => Some(PERIPHID_A::RTC),
            39 => Some(PERIPHID_A::RTCC),
            40 => Some(PERIPHID_A::SDIO),
            41 => Some(PERIPHID_A::SMU),
            42 => Some(PERIPHID_A::TIMER0),
            43 => Some(PERIPHID_A::TIMER1),
            44 => Some(PERIPHID_A::TIMER2),
            45 => Some(PERIPHID_A::TIMER3),
            46 => Some(PERIPHID_A::TRNG0),
            47 => Some(PERIPHID_A::UART0),
            48 => Some(PERIPHID_A::UART1),
            49 => Some(PERIPHID_A::USART0),
            50 => Some(PERIPHID_A::USART1),
            51 => Some(PERIPHID_A::USART2),
            52 => Some(PERIPHID_A::USART3),
            53 => Some(PERIPHID_A::USART4),
            54 => Some(PERIPHID_A::USB),
            55 => Some(PERIPHID_A::WDOG0),
            56 => Some(PERIPHID_A::WDOG1),
            57 => Some(PERIPHID_A::WTIMER0),
            58 => Some(PERIPHID_A::WTIMER1),
            _ => None,
        }
    }
