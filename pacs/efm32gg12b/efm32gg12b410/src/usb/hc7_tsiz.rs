...
pub struct R(crate::R<HC7_TSIZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HC7_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HC7_TSIZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HC7_TSIZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HC7_TSIZ` writer"]
pub struct W(crate::W<HC7_TSIZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HC7_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HC7_TSIZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HC7_TSIZ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERSIZE_W<'a> = crate::FieldWriter<'a, u32, HC7_TSIZ_SPEC, u32, u32, 19, 0>;
#[doc = "Field `PKTCNT` reader - Packet Count"]
pub type PKTCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PKTCNT` writer - Packet Count"]
pub type PKTCNT_W<'a> = crate::FieldWriter<'a, u32, HC7_TSIZ_SPEC, u16, u16, 10, 19>;
...
pub type PID_W<'a> = crate::FieldWriterSafe<'a, u32, HC7_TSIZ_SPEC, u8, PID_A, 2, 29>;
impl<'a> PID_W<'a> {
    #[doc = "DATA0 PID."]
    #[inline(always)]
