...
pub struct R(crate::R<HC2_CHAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HC2_CHAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HC2_CHAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HC2_CHAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HC2_CHAR` writer"]
pub struct W(crate::W<HC2_CHAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HC2_CHAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HC2_CHAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HC2_CHAR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LSPDDEV_W<'a> = crate::BitWriter<'a, u32, HC2_CHAR_SPEC, bool, 17>;
#[doc = "Endpoint Type\n\nValue on reset: 0"]
...
pub type EPTYPE_W<'a> = crate::FieldWriterSafe<'a, u32, HC2_CHAR_SPEC, u8, EPTYPE_A, 2, 18>;
impl<'a> EPTYPE_W<'a> {
