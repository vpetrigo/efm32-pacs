...
pub type WRSETUP_W<'a> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 3, 0>;
...
pub type WRSTRB_W<'a> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 7, 8>;
#[doc = "Field `WRHOLD` reader - Write Hold Time"]
pub type WRHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WRHOLD` writer - Write Hold Time"]
pub type WRHOLD_W<'a> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 3, 16>;
