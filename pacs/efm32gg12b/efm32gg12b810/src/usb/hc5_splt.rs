...
pub struct R(crate::R<HC5_SPLT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HC5_SPLT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HC5_SPLT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HC5_SPLT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HC5_SPLT` writer"]
pub struct W(crate::W<HC5_SPLT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HC5_SPLT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HC5_SPLT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HC5_SPLT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRTADDR_W<'a> = crate::FieldWriter<'a, u32, HC5_SPLT_SPEC, u8, u8, 7, 0>;
#[doc = "Field `HUBADDR` reader - Hub Address"]
pub type HUBADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HUBADDR` writer - Hub Address"]
pub type HUBADDR_W<'a> = crate::FieldWriter<'a, u32, HC5_SPLT_SPEC, u8, u8, 7, 7>;
...
pub type XACTPOS_W<'a> = crate::FieldWriter<'a, u32, HC5_SPLT_SPEC, u8, u8, 2, 14>;
...
pub type COMPSPLT_W<'a> = crate::BitWriter<'a, u32, HC5_SPLT_SPEC, bool, 16>;
#[doc = "Field `SPLTENA` reader - Split Enable"]
pub type SPLTENA_R = crate::BitReader<bool>;
#[doc = "Field `SPLTENA` writer - Split Enable"]
pub type SPLTENA_W<'a> = crate::BitWriter<'a, u32, HC5_SPLT_SPEC, bool, 31>;
impl R {
