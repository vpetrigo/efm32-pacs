...
pub type SDIOCLKENS_R = crate::BitReader<bool>;
#[doc = "Field `QSPI0CLKENS` reader - QSPI0 Clock Enabled Status"]
pub type QSPI0CLKENS_R = crate::BitReader<bool>;
#[doc = "Field `PDMCLKENS` reader - PDM Clock Enabled Status"]
pub type PDMCLKENS_R = crate::BitReader<bool>;
...
impl R {
    ...
    pub fn pdmclkens(&self) -> PDMCLKENS_R {
        PDMCLKENS_R::new(((self.bits >> 19) & 1) != 0)
    }
