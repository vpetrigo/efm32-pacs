...
#[doc = "Field `DV` reader - DV Interrupt Enable"]
pub type DV_R = crate::BitReader<bool>;
#[doc = "Field `DV` writer - DV Interrupt Enable"]
pub type DV_W<'a> = crate::BitWriter<'a, u32, IEN_SPEC, bool, 0>;
#[doc = "Field `DVL` reader - DVL Interrupt Enable"]
pub type DVL_R = crate::BitReader<bool>;
#[doc = "Field `DVL` writer - DVL Interrupt Enable"]
