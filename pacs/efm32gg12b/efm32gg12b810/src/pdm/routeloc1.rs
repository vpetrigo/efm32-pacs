...
#[doc = "Field `CLKLOC` reader - I/O Location for CLK pin"]
...
#[doc = "Field `CLKLOC` writer - I/O Location for CLK pin"]
pub type CLKLOC_W<'a> = crate::FieldWriter<'a, u32, ROUTELOC1_SPEC, u8, CLKLOC_A, 6, 0>;
impl<'a> CLKLOC_W<'a> {
    #[doc = "Location 0"]
    #[inline(always)]
