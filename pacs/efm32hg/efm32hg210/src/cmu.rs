...
pub struct RegisterBlock {
    ...
    pub ushfrcotune: crate::Reg<ushfrcotune::USHFRCOTUNE_SPEC>,
    #[doc = "0xdc - USHFRCO Configuration"]
    pub ushfrcoconf: crate::Reg<ushfrcoconf::USHFRCOCONF_SPEC>,
}
...
#[doc = "USHFRCO Control"]
pub mod ushfrcoctrl;
#[doc = "USHFRCOTUNE register accessor: an alias for `Reg<USHFRCOTUNE_SPEC>`"]
pub type USHFRCOTUNE = crate::Reg<ushfrcotune::USHFRCOTUNE_SPEC>;
#[doc = "USHFRCO Frequency Tune"]
pub mod ushfrcotune;
#[doc = "USHFRCOCONF register accessor: an alias for `Reg<USHFRCOCONF_SPEC>`"]
