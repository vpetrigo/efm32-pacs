...
pub type LFC_W<'a> = crate::FieldWriter<'a, u32, LFCLKSEL_SPEC, u8, LFC_A, 2, 4>;
impl<'a> LFC_W<'a> {
...
pub type LFAE_W<'a> = crate::BitWriter<'a, u32, LFCLKSEL_SPEC, bool, 16>;
...
pub type LFBE_W<'a> = crate::BitWriter<'a, u32, LFCLKSEL_SPEC, bool, 20>;
impl R {
